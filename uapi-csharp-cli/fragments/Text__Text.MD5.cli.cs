...
namespace UAPI.CliGenerated
{
    public static class Cli_Text_Text_MD5
    {
            ...
            Option<string> authenticationOption)
        {
            ...
            cmd_text_md5_1.SetAction(async parseResult =>
            {
                ...
                var result = await Text.CreateMD5(texts, requestType, AuthenticationAPITokenKey);
            ...
            cmd_text_created_md5_2.SetAction(async parseResult =>
            {
                ...
                var AuthenticationAPITokenKey = parseResult.GetValue(authenticationOption);
                var result = await Text.ReturnCreatedMD5(text, requestType, AuthenticationAPITokenKey);
                CliOutput.WriteObject(result, parseResult.GetValue(outOption), parseResult.GetValue(appendOption));
            });
        }
    }
